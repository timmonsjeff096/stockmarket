...
def main():
    ...
    training_data = read_csv("../data/numerai_dataset_258/numerai_training_data.csv")
    # The tournament data is the data that Numerai uses to evaluate your model.
    tournament_data = read_csv("../data/numerai_dataset_258/numerai_tournament_data.csv")
